...
class SolutionControllerTest {
    ...
    void getSolutionList_1() throws Exception {
        ...
        when(solutionService.getSolutionList(any(User.class),anyLong(),any(Pageable.class))).thenReturn(pagedResponse);
        // when, then
        ...
        verify(solutionService,times(1)).getSolutionList(user, problemId, pageable);
    }
    ...
    void getSolutionListFailed_1() throws Exception {
        // given
        Pageable pageable = PageRequest.of(0,20);
        when(solutionService.getSolutionList(any(User.class),anyLong(),any(Pageable.class)))
